...
<div class="date-nav clear-block">
  <div class="date-prev">
    <?php if (!empty($prev_url)) : ?>
      <span class="next">&laquo;  <?php print l(($block ? '' : t('Prev', array(), array('context' => 'date_nav'))), $prev_url, $prev_options); ?></span>
    <?php endif; ?>
  &nbsp;</div>
  ...
  <div class="date-next">&nbsp;
    <?php if (!empty($next_url)) : ?>
      <span class="next"> <?php print l(($block ? '' : t('Next', array(), array('context' => 'date_nav'))), $next_url, $next_options); ?>  &raquo;</span>
    <?php endif; ?>  
  </div>
</div>